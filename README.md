Background:
This repository’s code and data accompany the manuscript, Codon usage and gene expression patterns associated with five-year survival rates in cancer patients. In this study, novel quantitative techniques were performed on four cancer types from The Cancer Genome Atlas: Kidney Renal Cell Carcinoma, Head and Neck Squamous Cell Carcinoma, Lung Squamous Cell Carcinoma, and Brain Lower Grade Glioma. This code and data were used to identify new prognostic markers for these cancer types and explore the survival mechanisms.
...
2. HPC Transcriptomic-Weighted Codon Usage and Survival.R
This script calculated the transcriptomic weighted codon usage of the samples for each cancer type. 
3. Local Preparation for Differential Gene Expression.R
...
Authors:
Nathan J. Clement 1, +, Haim Bar 2, +, Ryan C. Hunt 1+, Douglas Meyer 1, Anton A. Komar 3, Michael DiCuccio 4, and Chava Kimchi-Sarfaty 1, *
Affiliations:
1 Hemostasis Branch 1, Division of Hemostasis, Office of Plasma Protein Therapeutics CMC, Office Therapeutic Products, Center for Biologics Evaluation and Research, Food and Drug Administration, Silver Spring, USA.
2 Department of Statistics, University of Connecticut, Storrs, CT, USA.
3 Center for Gene Regulation in Health and Disease, Department of Biological, Geological and Environmental Sciences, Cleveland State University, Cleveland, OH, USA.
4 Rockville, MD, USA.
+ Equal contributor
* Corresponding author
Please direct questions to Nathan Clement (nathan.clement@fda.hhs.gov) and Chava Kimchi-Sarfaty (chava.kimchi-sarfaty@fda.hhs.gov).
